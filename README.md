...
```bash
npm install --global https://github.com/RavenholmAlpha/CorvusAI/releases/download/v0.1.1/ravenholmalpha-corvus-0.1.1.tgz
```
...
Current release: [v0.1.1](https://github.com/RavenholmAlpha/CorvusAI/releases/tag/v0.1.1).
