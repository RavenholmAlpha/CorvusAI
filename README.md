...
```bash
npm install --global https://github.com/RavenholmAlpha/CorvusAI/releases/download/v0.2.2/ravenholmalpha-corvus-0.2.2.tgz
```
...
Current release: [v0.2.2](https://github.com/RavenholmAlpha/CorvusAI/releases/tag/v0.2.2).
