...
export class HttpMcpClient {
 ...
 async connect():Promise<void>{await this.request("initialize",{protocolVersion:"2024-11-05",capabilities:{},clientInfo:{name:"corvus",version:"0.3.3"}});await this.notify("notifications/initialized")}
